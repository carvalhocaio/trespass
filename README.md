...
- Open GitHub Issue directly from any finding — pre-fills title, severity, snippet, and remediation and opens the GitHub new-issue form directly
...
```bash
pnpm test          # run all 117 tests across the suite
```
